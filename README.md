...
```bash
# 检查所有代码（忽略trace目录）
python -m flake8 github_utils/ GitHub-main-主界面/main_gui.py --ignore=trace

# 检查整个项目（忽略特定目录）
python -m flake8 . --ignore=trace --exclude=github-checker-检测状态
```
...
per-file-ignores =
    __init__.py: F401
    GitHub-main-主界面/main_gui.py: E402
```
