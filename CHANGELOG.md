...
- 修复了 IP 测试结果格式不匹配问题，将列表格式转换为字典格式，确保测试结果能正确处理
- 优化了一键检测修复的 IP 测试逻辑，确保能正确选择最佳 IP

## [v1.2.1] - 2026-01-02

### 修复

- 修复了指示灯会正常更新颜色，但不会更新时间戳的问题
- 修复了不同工具返回格式兼容性问题，解决了运行一键检测修复工具时出现的KeyError: 'status'异常
